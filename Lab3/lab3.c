...
//int scanToEnd(int lower, float d, float prev, cyBOT_Scan_t *getScan,
...
//    char data[15];
//    prevDist = prev;
//    for (i = lower; i <= 180; i += 2)
//    {
//        cyBOT_Scan(i, *&getScan);
//        prevDist = dist;
//        dist = getScan->sound_dist;
//        if (abs(prevDist - dist) >= 60)
//        {
//            obj->radial_width = i - lower;
//            sprintf(data, "%d %10s %f", i, "", dist);
//            return i;
//        }
//    }
//    return i;
